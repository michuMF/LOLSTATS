...
export const LiveGamePage = () => {
  ...
  const {
    ...
    error: summonerError,
  } = useSummonerData(gameName!, tagLine!, region!);
      ...
      <div className="min-h-[50vh] flex flex-col items-center justify-center gap-6">
        <div className="text-center">
          ...
          <p className="text-slate-500 text-lg">
            {!isInGame
              ? "Ten gracz nie jest aktualnie w grze."
  ...
  return (
    <div className="animate-fadeIn w-full max-w-7xl mx-auto pt-6 pb-20 px-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 relative">
        <div className="hidden lg:flex absolute left-1/2 top-10 -translate-x-1/2 w-12 h-12 bg-slate-800 rounded-full items-center justify-center text-white font-black z-10 border-4 border-white shadow-lg">
          VS
        </div>

        <div className="space-y-4">
          <h3 className="text-blue-600 font-bold text-xl mb-4 border-b-2 border-blue-100 pb-2">
            Blue Team
          </h3>
          {blueTeam.map((p, idx) => (
            <ParticipantCard
        ...
        <div className="space-y-4">
          <h3 className="text-red-500 font-bold text-xl mb-4 text-right border-b-2 border-red-100 pb-2">
            Red Team
          </h3>
          {redTeam.map((p, idx) => (
            <ParticipantCard
